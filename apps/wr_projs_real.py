...
# Read in data
df_y1 = pd.read_csv('data/wr_y1_preds.csv')
df_all = pd.read_csv('data/wr_y1-y3_preds.csv')
...
layout = html.Div([
    dbc.Container([
        dbc.Row([
            dbc.Col([html.Br(),
                     html.H1("Wide Reciever Prospect Fantasy Projections",
...
#                            height='30px',
#                        ),
#                        href='https://twitter.com/lukeneuendorf',
#                        target='_blank',
#                    ),
#                    html.A(
#                        html.Img(
...
# Callbacks
@app.callback([Output('wr-all-plot','figure'),
               Output('wr-y1-plot','figure')],
              [Input('wr-year-selector','value'),
               Input('wr-sort-selector','value')])
...
@app.callback([Output('wr-all-table','data'),
               Output('wr-all-table','columns'),
               Output('wr-y1-table','data'),
               Output('wr-y1-table','columns')],
              [Input('wr-year-selector','value'),
               Input('wr-sort-selector','value')])
...
@app.callback(Output('wr-all-loading','children'),Input('wr-all-plot','value'))
